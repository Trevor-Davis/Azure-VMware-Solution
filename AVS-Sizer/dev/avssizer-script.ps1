########################################################################################
# Installs ImportExcel if needed
########################################################################################
...
$app.Run("AssignvInfoLabels") # Run the Excel Macro in the Sizer file to label all the VMs into their categories.
...
$fttraid52SQL = $response52SQL.sddclist.clusterlist.sazcopensizlusters.clusterInfoList.fttFtmType
...
$excel.Range("N2") = $fttraid36pAllIn #writes the rvtools file path and filename to the sizer sheet so the excel macro knows where it's located.
$excel.Range("N3") = $fttraid52AllIn #writes the rvtools filename to the sizer sheet so the excel macro knows where it's located.
$excel.Range("N4") = $fttraid36pWindows #writes the rvtools file path and filename to the sizer sheet so the excel macro knows where it's located.
$excel.Range("N5") = $fttraid52Windows #writes the rvtools filename to the sizer sheet so the excel macro knows where it's located.
$excel.Range("N6") = $fttraid36pSQL #writes the rvtools file path and filename to the sizer sheet so the excel macro knows where it's located.
$excel.Range("N7") = $fttraid52SQL #writes the rvtools filename to the sizer sheet so the excel macro knows where it's located.
$excel.Range("N8") = $fttraid36pLinux #writes the rvtools file path and filename to the sizer sheet so the excel macro knows where it's located.
$excel.Range("N9") = $fttraid52Linux #writes the rvtools filename to the sizer sheet so the excel macro knows where it's located.
$excel.Range("N10") = $fttraid36pOther #writes the rvtools file path and filename to the sizer sheet so the excel macro knows where it's located.
$excel.Range("N11") = $fttraid52Other #writes the rvtools filename to the sizer sheet so the excel macro knows where it's located.
